...
function Resume() {
    return (
    <div>
        <div style="margin-top:20px; margin-right:5px; margin-left:5px;">
        ...
        <a href="Assets/Brand Statement.pdf" download class="waves-effect waves-light btn-large" style="margin-bottom:25px;">Download Resume</a>
        </div>
    </div>
    );
}
